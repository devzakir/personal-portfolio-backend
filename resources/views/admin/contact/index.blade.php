                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="width:150px">
                                <a href="{{ route('contact.edit', $c->id) }}" class="btn btn-success btn-sm"> <span
                                        class="mdi mdi-square-edit-outline"></span> </a>
                                <a href="{{ route('contact.show', $c->id) }}" class="btn btn-primary btn-sm ml-1"> <span
                        ...
                        <tr>
                            <td colspan="6">
                                <h5 class="text-center pt-4 pb-4">No Messages Found</h5>
                            </td>
                        </tr>
                        @endif
                    </tbody>
