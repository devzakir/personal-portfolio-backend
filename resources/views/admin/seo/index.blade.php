                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="max-width:500px;">
                                <a href="{{ route('seo.edit', $c->id) }}" class="btn btn-success btn-sm"> <span
                                        class="mdi mdi-square-edit-outline"></span> </a>
                                <a href="#" class="btn btn-primary btn-sm"> <span class="mdi mdi-eye"></span> </a>
                                <a href="{{ route('seo.destroy', $c->id) }}" class="btn btn-danger btn-sm"> <span
                        ...
                        <tr>
                            <td colspan="6">
                                <h5 class="text-center">No SEO Data Found</h5>
                            </td>
                        </tr>
                        @endif
                    </tbody>
