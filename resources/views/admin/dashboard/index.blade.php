  ...
  <div class="row">
    ...
    <div class="col-xl-4 col-12">
      ...
      <div class="card card-default" data-scroll-height="550" style="height: 550px; overflow: hidden;">
        ...
        </div><div class="slimScrollBar" style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 303.732px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        <div class="mt-3"></div>
      </div>
    </div>
  </div>
