                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="width:150px">
                                <a href="{{ route('portfolio-category.edit', $c->id) }}" class="btn btn-success btn-sm">
                                    <span class="mdi mdi-square-edit-outline"></span> </a>
                                <a href="#" class="btn btn-primary btn-sm ml-1"> <span class="mdi mdi-eye"></span> </a>
                                <form action="{{ route('portfolio-category.destroy', $c->id) }}" method="post"
                                    class="ml-1">
                                    @csrf @method('DELETE')
